...
STYLESHEET = """
    ...
    /* --- PAINÉIS COM SOMBRA --- */
    #Sidebar, #ContentFrame, #LoginFrame {
    ...
    QPushButton[class="table-success"] {
       background-color: #22c55e; /* verde */
    color: white;              /* garante que o texto apareça */
    border-radius: 6px;
    padding: 6px 12px;
    font-weight: bold;
    }
    QPushButton[class="table-success"]:hover { background-color: #16a34a; }
    QPushButton[class="table-success"]:disabled { background-color: #166534; color: #d1d5db; }
"""